...
{
 	static $liveIDUsername = "website@topbike.onmicrosoft.com";
	static $liveIDPassword = "WS__2k14";
	/*
 	private static $liveIDUsername = "admin@topbike.onmicrosoft.com";
	private static $liveIDPassword = "2012Topbike";
	*/
	static $organizationServiceURL = "https://topbike.crm4.dynamics.com/XRMServices/2011/Organization.svc";
	static $securityData = null;
	...
	public function __construct($IDUsername = null, $IDPassword = null)
	{
		if (null === $IDUsername) $IDUsername = DynamicsIntegrator::$liveIDUsername;
		if (null === $IDPassword) $IDPassword = DynamicsIntegrator::$liveIDPassword;
		// Your "heavy" initialization stuff here
		$liveIDManager = new LiveIDManager();
		DynamicsIntegrator::$securityData = $liveIDManager->authenticateWithLiveID( self::$organizationServiceURL, $IDUsername, $IDPassword );
	}

	function getSecurityData() {
		return DynamicsIntegrator::$securityData;
	}

	function checkAvailability($resources, $start_date, $end_date, $start_time = "05:00:00", $end_time = "05:00:00")
	{
	...
	public static function createContact($info) {
